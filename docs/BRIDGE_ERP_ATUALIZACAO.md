...
O comando findstr deve mostrar `bom-safe-semantic-cutout-v10`. Essa versao considera
descricao, P1/P2/PB1/PB2, subconjuntos com `+`, exclusao rigida de Lista de Materiais/BOM, vistas principais alongadas,
...
Reload e reabrir a tela. A chave v10 invalida automaticamente as previas antigas.
