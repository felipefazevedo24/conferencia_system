...
from ..services.classificacao_contabil_service import classificar_nota
...
def listar_registros_conferencia_simples():
    ...
    for reg in registros:
        ...
        result.append({
            ...
            "sem_conferencia_justificativa": reg.sem_conferencia_justificativa,
...
def criar_registro_conferencia_simples():
    ...
    return jsonify({
        "registro": {
            ...
            "sem_conferencia_justificativa": registro.sem_conferencia_justificativa,
