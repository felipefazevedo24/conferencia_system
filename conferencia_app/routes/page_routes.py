...
HOME_MODULES = [
    ...
    },
    {
        "id": "producao",
        "title": "Produção",
        "subtitle": "OS e montagem",
        "description": "Acompanhe a estrutura das OS, operações, progresso e bloqueios produtivos.",
        "href": "/producao",
        "icon": "fa-industry",
        "permission": "PAGE_PRODUCAO",
        "section": "Operação",
        "tone": "orange",
        "priority": 86,
        "keywords": ["producao", "os", "montagem", "fabricacao", "estrutura", "pcp"],
        "metric_key": "agendamento_ativo",
    },
    {
        "id": "rpa_agrupamento",
        "title": "RPA agrupamento",
        "subtitle": "Consulta e preparo de chapas",
        "description": "Consulte processos de Corte Laser, confira materiais compativeis e prepare codigos para agrupamento.",
        "href": "/producao/rpa-agrupamento",
        "icon": "fa-layer-group",
        "permission": "PAGE_PRODUCAO",
        "section": "Operação",
        "tone": "orange",
        "priority": 85,
        "keywords": ["rpa", "agrupamento", "chapa", "corte laser", "processo"],
        "metric_key": "agendamento_ativo",
    },
    {
        "id": "comex_processos",
