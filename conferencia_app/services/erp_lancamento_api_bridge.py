...
PEDIDOS_SQL = """
    ...
    select
        ...
        oc.bairro, oc.cidade, oc.uf, oc.cep, oc.observacoes, oc.data_pedido, oc.cond_pagamento,
        oc.forma_pgto, oc.prazo_entrega, oc.solicitante, oc.tipo_movimento, oc.subtotal, oc.totalgeral,
        oc.vl_frete, oc.vl_desconto, oc.ipi_total, oc.icms_total,
