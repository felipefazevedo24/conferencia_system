...
class RegisterSchema(Schema):
    ...
    role = fields.Str(required=True, validate=validate.OneOf(["Admin", "Fiscal", "Logística", "Logistica", "Portaria", "Financeiro", "Controladoria", "Compras", "Motorista", "Solicitante", "Qualidade"]))
